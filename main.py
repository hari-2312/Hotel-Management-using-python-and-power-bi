...
Label(sroot,text="Hari",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="hkrishnan1212@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
